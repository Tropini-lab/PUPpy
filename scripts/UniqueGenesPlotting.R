...
# Script: UniqueGenesPlotting.R
# Part of PUPpy distribution.
# Run from 'puppy-primers' script.
# Plots number of unique and total number of genes for each member of the defined community.

# Author = Hans Ghezzi
# Credits = Hans Ghezzi, Katharine M. Ng, Yiyun Michelle Fan 
# Licence = GPL3
# Version = 1.0.0
...
# Load intermediate file, UniqueGenesList.tsv, generated through puppy-primers script.
data = read.table(file = file.path(args[1], "UniqueGenesList.tsv"), sep = '\t', header = TRUE)
